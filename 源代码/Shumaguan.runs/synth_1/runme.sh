...
HD_PWD='D:/vivadotest/Shumaguan/Shumaguan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IOtest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IOtest.tcl
