...
HD_PWD='D:/vivadotest/Shumaguan/Shumaguan.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IOtest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IOtest.tcl -notrace
